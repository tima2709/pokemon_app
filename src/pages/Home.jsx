...
import {getPokemons, getTypes, setPage, setPageSize} from "../redux/slices/pokemonSlice";
    ...
    return (
        <Container sx={{padding: '20px'}}>
            <div className={styles.sort_and_select}>
                ...
                <TypesOfPokemon types={types} selectedType={typesOfPokemon} setSelectedType={setTypesOfPokemon}/>
            </div>
            <Grid container spacing={2} direction="row" justifyContent="center" alignItems="center">
                {isLoading ? (
                    [...Array(8)].map((_, idx) => <Card key={idx} isLoading={isLoading} />)
                ) : pokemons.length === 0 ? (
